...
tdd_state:
  ...
  exit_code: 1
  evidence: "Test test_list_given_existing_items_should_keep_sort_order failed for expected sort-order reason"
```
...
tdd_state:
  ...
  command: "pytest tests/test_list.py::test_list_given_existing_items_should_keep_sort_order"
  exit_code: 0
  evidence: "Targeted test passed after minimal production change"
```
